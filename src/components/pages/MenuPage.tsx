            ...
            {isLoading ? null : filteredItems.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
                {filteredItems.map((item, index) => (
                  ...
                  >
                    <div className="aspect-[4/3] bg-primary/5 mb-4">
                      <Image
                    ...
                    <div className="space-y-2">
                      {item.category && (
                        <span className="inline-block font-paragraph text-xs uppercase text-primary/60 tracking-wider">
                          {item.category}
                        </span>
                      )}
                      <h3 className="font-heading text-xl lg:text-2xl uppercase text-primary">
                        {item.dishName}
                      </h3>
                      {item.description && (
